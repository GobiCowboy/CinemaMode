...
| 303 | 退出并恢复 | 已实现 | 300_features/303_exit_and_restore.md | `Sources/CinemaModeCore/Services/CinemaModeService.swift`, `Sources/CinemaMode/Services/SystemPresentationController.swift`, `Sources/CinemaMode/Services/FloatingPanelController.swift`, `Sources/CinemaMode/Services/SystemPointerActivityMonitor.swift`, `Sources/CinemaMode/Services/SystemFeedbackBannerController.swift` | `CinemaModeService`, `SystemPresentationController`, `FloatingPanelController`, `SystemFeedbackBannerController` | 与 301 共用状态机和覆盖层恢复 |
| 304 | 设置与偏好 | 开发中 | 300_features/304_settings_and_preferences.md | `Sources/CinemaModeCore/Stores/PreferencesStore.swift`, `Sources/CinemaModeCore/Support/AppLanguage.swift`, `Sources/CinemaMode/Views/SettingsView.swift`, `Sources/CinemaMode/Services/SettingsWindowController.swift`, `Sources/CinemaMode/App/MenuBarStatusItemController.swift` | `PreferencesStore`, `SettingsWindowController` | 与 301-303 共用用户偏好配置 |
